        ...
        <aside className="items-center sm:flex">
            ...
            <div className="flex flex-col  mb-4">
                ...
                <p className="flex items-center gap-2">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" className="w-5 h-5">
